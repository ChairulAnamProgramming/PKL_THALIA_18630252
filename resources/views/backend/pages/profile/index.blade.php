                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control"
                                value="{{ $population ? $population->nik : old('nik') }}" id="nik" name="nik"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="gender" name="gender">
                                ...
                                <option {{ $population ? ($population->gender === 'male' ? 'selected' : '') : '' }}
                                    value="male">
                                    Laki-laki</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="marital_status" name="marital_status">
                                <option value="">Pilih</option>
                                <option
                                    {{ $population ? ($population->marital_status === 'Kawin' ? 'selected' : '') : '' }}
                                    value="Kawin">
                                    Kawin
                                </option>
                                <option
                                ...
                                <option
                                    {{ $population ? ($population->marital_status === 'Cerai' ? 'selected' : '') : '' }}
                                    value="Cerai">
                                    Cerai
                                </option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="religion" name="religion">
                                ...
                                <option
                                    {{ $population ? ($population->religion === 'Protestan' ? 'selected' : '') : '' }}
                                    value="Protestan">
                                    Protestan
                                </option>
                                ...
                                <option
                                    {{ $population ? ($population->religion === 'Khonghucu' ? 'selected' : '') : '' }}
                                    value="Khonghucu">
                                    Khonghucu
                                </option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            @if ($population)
                                <img src="{{ url('storage') . '/' . $population->image }}" class="img-fluid"
                                    width="100" alt="">
                            @else
